...
<?php if(pings_open()) ://if trackback is open ?>
   <li id="comment_switch" class="comment_switch_active"><a href="javascript:void(0);" class="col-sm-60 col-xs-60"><?php _e('Comments','tcd-w'); ?><?php echo (' ( ' . (count($comments)-count($trackbacks)) . ' )'); ?></a></li>
   <li id="trackback_switch"><a href="javascript:void(0);" class="col-sm-60 col-xs-60"><?php _e('Trackback','tcd-w'); ?><?php echo (' ( ' . count($trackbacks) . ' )'); ?></a></li>
<?php else ://if comment is closed,show onky number ?>
   <li id="comment_closed"><p class="col-sm-60 col-xs-60"><?php _e('Comments', 'tcd-w'); echo (' (' . (count($comments)-count($trackbacks)) . ')'); ?></p></li>
   <li id="trackback_closed"><p class="col-sm-60 col-xs-60"><?php _e('Trackback are closed','tcd-w'); ?></p></li>
<?php endif; ?>
 </ul>
