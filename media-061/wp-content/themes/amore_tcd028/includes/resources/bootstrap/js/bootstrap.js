...
+function(t) {
    ...
    i.VERSION = "3.3.1", i.TRANSITION_DURATION = 600, i.DEFAULTS = {
        ...
        var i = "prev" == t ? -1 : 1, o = (this.getItemIndex(e) + i) % this.$items.length;
    ...
    function e(e) {
        e && 3 === e.which || (t(s).remove(), t(n).each(function() {
            ...
            s.hasClass("open") && (s.trigger(e = t.Event("hide.bs.dropdown", n)), e.isDefaultPrevented() || (o.attr("aria-expanded", "false"), 
    ...
    a.VERSION = "3.3.1", a.prototype.toggle = function(o) {
        ...
        if (/(38|40|27|32)/.test(e.which) && !/input|textarea/i.test(e.target.tagName)) {
            ...
            if (e.preventDefault(), e.stopPropagation(), !o.is(".disabled, :disabled")) {
                ...
                if (!a && 27 != e.which || a && 27 == e.which) return 27 == e.which && s.find(n).trigger("focus"), 
                o.trigger("click");
    ...
    i.VERSION = "3.3.1", i.TRANSITION_DURATION = 300, i.BACKDROP_TRANSITION_DURATION = 150, 
    i.DEFAULTS = {
        backdrop: !0,
        keyboard: !0,
        show: !0
        ...
        this.backdrop(function() {
            ...
            o.options.backdrop && o.adjustBackdrop(), o.adjustDialog(), s && o.$element[0].offsetWidth, 
            o.$element.addClass("in").attr("aria-hidden", !1), o.enforceFocus();
    ...
    function e(e) {
        return this.each(function() {
            ...
            (s || "destroy" != e) && (a ? (s || o.data("bs.tooltip", s = {}), s[a] || (s[a] = new i(this, n))) : s || o.data("bs.tooltip", s = new i(this, n)), 
            "string" == typeof e && s[e]());
        });
    }
    var i = function(t, e) {
    ...
    i.VERSION = "3.3.1", i.TRANSITION_DURATION = 150, i.DEFAULTS = {
        ...
        if (i && i.$tip && i.$tip.is(":visible")) i.hoverState = "in"; else {
            ...
            !i.options.delay || !i.options.delay.show) return i.show();
        ...
        !i.options.delay || !i.options.delay.hide) return i.hide();
        i.timeout = setTimeout(function() {
        ...
        var i = (e = e || this.$element)[0], o = "BODY" == i.tagName, s = i.getBoundingClientRect();
    ...
    function e(e) {
        return this.each(function() {
            ...
            (s || "destroy" != e) && (a ? (s || o.data("bs.popover", s = {}), s[a] || (s[a] = new i(this, n))) : s || o.data("bs.popover", s = new i(this, n)), 
            "string" == typeof e && s[e]());
        });
    }
    var i = function(t, e) {
    ...
    i.VERSION = "3.3.1", i.TRANSITION_DURATION = 150, i.prototype.show = function() {
        ...
        function n() {
            ...
            e.addClass("in")) : e.removeClass("fade"), e.parent(".dropdown-menu") && e.closest("li.dropdown").addClass("active").end().find('[data-toggle="tab"]').attr("aria-expanded", !0), 
            s && s();
        }
    ...
    function i(e) {
        return this.each(function() {
            ...
            !s && n.toggle && "show" == e && (n.toggle = !1), s || i.data("bs.collapse", s = new o(this, n)), 
            "string" == typeof e && s[e]();
        });
    }
    var o = function(e, i) {
        this.$element = t(e), this.options = t.extend({}, o.DEFAULTS, i), this.$trigger = t(this.options.trigger).filter('[href="#' + e.id + '"], [data-target="#' + e.id + '"]'), 
    ...
    t.fn.collapse = i, t.fn.collapse.Constructor = o, t.fn.collapse.noConflict = function() {
        ...
        var n = e(s), a = n.data("bs.collapse") ? "toggle" : t.extend({}, s.data(), {
            trigger: this
        });
        i.call(n, a);
    });
