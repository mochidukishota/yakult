!function(t, i, e, s) {
    function o(i, e) {
        ...
        n = !0), this.$mirror.addClass("parallax-mirror").css({
            ...
            left: 0,
            overflow: "hidden"
        }).attr("data-order", this.$element.attr("data-order")), this.$slider.addClass("parallax-slider").one("load", function() {
    ...
    !function() {
        ...
        setup: function() {
            if (!this.isReady) {
                var t = jQuery(e), s = jQuery(i), h = function() {
                    o.winHeight = s.height(), o.winWidth = s.width(), o.docHeight = t.height(), o.docWidth = t.width();
                }, r = function() {
                    var t = s.scrollTop(), i = o.docHeight - o.winHeight, e = o.docWidth - o.winWidth;
                    o.scrollTop = Math.max(0, Math.min(i, t)), o.scrollLeft = Math.max(0, Math.min(e, s.scrollLeft())), 
                    o.overScroll = Math.max(t - i, Math.min(t, 0));
                };
                s.on("resize.px.parallax load.px.parallax", function() {
                    h(), o.isFresh = !1, o.requestRender();
                }).on("scroll.px.parallax load.px.parallax", function() {
                    r(), o.requestRender();
                }), h(), r(), jQuery(i).load(function() {
